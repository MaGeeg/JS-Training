// names of variables - in JavaScript we should use comelCase:
...
// depends - if You decide to use demicolons, then use them at the end of ech line in your code
// depends - if You decide NOT to use demicolons, then do NOT use them :)
