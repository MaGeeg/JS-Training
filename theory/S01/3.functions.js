...
// Other example of function, that resturn value:
function getHello() {
    return 'Hello World!'
}
...
// ! moj sposob
function getHello1(val) {
    return val
    
}

// to use functions just call it by name and assign result to new variable:
const helloq = getHello1('Hello World!')
console.log('result of getHello():', helloq)
...
// Function can return some value but it optional!
// as an example:
